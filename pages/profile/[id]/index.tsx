...
const OtherProfile: NextPage = () => {
  ...
  const [state, setState] = useState<"post" | "product" | "review">();
    ...
    <Layout title={`${userData?.user?.name}님의 당근`} hasTabBar>
      <div className="px-4 py-4 md:mx-auto md:max-w-4xl">
        ...
        <div className="flex justify-between px-2 my-12 md:px-14">
          ...
          <Link href={`${router.query.id}/bought`}>
            <a>
              <div className="flex flex-col justify-center text-sm">
                <div className="w-14 h-14 rounded-full bg-orange-400 flex justify-center items-center text-white mb-2 hover:bg-orange-600 shadow-sm  flex-col self-center">
                  <svg
          ...
          <Link href={`${router.query.id}/loved`}>
            <a>
              <div className="flex flex-col justify-center text-sm">
                <div className="w-14 h-14 rounded-full bg-orange-400 flex justify-center items-center text-white mb-2 hover:bg-orange-600 shadow-sm  flex-col self-center">
                  <svg
        ...
        <div className="md:flex sm:space-y-14 md:justify-center md:space-x-32 md:mt-20">
          <div>
            <div
              className="flex pb-1 border-b md:border-none w-40 cursor-pointer"
              onClick={() => {
                setState("post");
              }}
            >
          ...
          <div>
            <div
              ...
              className="flex pb-1 border-b md:border-none w-36 cursor-pointer"
            >
              <button className=" text-sm font-bold pr-1">
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill={`${state === "product" ? `orange` : `none`}`}
                viewBox="0 0 24 24"
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-6 h-6 "
        ...
        <div className="sm:hidden">
          {state === "post" ? (
            <div>
              {userData?.post?.map((post: any) => (
                <div key={post?.id} className="border-b md:border-none">
                  <Link href={`/community/${post?.id}`}>
                    <a>
                      <div className="flex flex-col items-start my-4">
                        <span className="bg-gray-100 text-gray-700 px-2.5 py-0.5 rounded-full text-sm  mb-2">
